...
?>
                ...
                <div class="category-heading-content category-heading-content__2 text-uppercase">
                    ...
                    <div class="find">
                        ...
                        <div class="form-actions">
                                    ...
                                    <input type="submit" value="Go Back To Search" onclick="javascript:window.location='course_list.php';">
                                </div>
                    </div>
                </div>
            </div>
	...
	$sql="SELECT * FROM `course` WHERE course_category='$category'";
...
?>
                                ...
                                <div class="trip-item">
                                    ...
                                    <div class="item-price-more">
                                        ...
                                        <a href="#" class="awe-btn">Enroll now</a>
                                    </div>
                                </div>
								<?php	
